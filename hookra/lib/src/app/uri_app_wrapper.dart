...
class UriAppWrapper extends StatefulWidget {
  const UriAppWrapper({super.key});

  @override
  State<UriAppWrapper> createState() => _UriAppWrapperState();
}

class _UriAppWrapperState extends State<UriAppWrapper> {
  ...
  void _handleUri(Uri? uri) async {
    ...
    if (uri.path.contains('reset-password') &&
      ...
      if (accessToken != null && accessToken.isNotEmpty) {
        ...
        AuthTokenHolder.instance.setTokens(accessToken: accessToken);
